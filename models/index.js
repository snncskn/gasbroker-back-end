...
db.company_type.belongsTo(db.company, { as: "company", foreignKey: "company_id"});
db.company.hasMany(db.company_type, { as: "company_types", foreignKey: "company_id"});
...
db.company_type.belongsTo(db.type, { as: "type", foreignKey: "type_id"});
db.type.hasMany(db.company_type, { as: "company_types", foreignKey: "type_id"});
