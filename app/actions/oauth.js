...
export function facebookLogin() {
  const facebook = {
    url: 'http://localhost:3300/auth/facebook',
    clientId: '980220002068787',
    redirectUri: 'http://localhost:3300/auth/facebook/callback',
...
export function twitterLogin() {
  const twitter = {
    url: 'http://localhost:3300/auth/twitter',
    redirectUri: 'http://localhost:3300/auth/twitter/callback',
...
export function googleLogin() {
  const google = {
    url: 'http://localhost:3300/auth/google',
    clientId: '363383570190-od1vu7poa9i0o777knub8qc8q512s9u0.apps.googleusercontent.com',
    redirectUri: 'http://localhost:3300/auth/google/callback',
